...
# python subspace_edit_layer.py --recal --kappa 0.01 --lora_rank 8 --instruction_prompt default --exp_mode test --clf_only 0 --exp test --model_name llama_7B --device 0 --num_fold 2 --judge_name ft:davinci-002:ethicalytics:truthful:A0WsrZ0l --info_name ft:davinci-002:ethicalytics:truthful:A0WsrZ0l --eval_dataset truthful_qa --train_dataset truthful_qa --save_folder /big_storage/baonn/subspace --cache_dir /home/users/nus/binhnt/scratch/.cache/huggingface/hub --loss_type cross_entropy