...
def main(): 
    ...
    if args.dataset_name == "tqa_gen" or args.dataset_name == "tqa_gen_end_q": 
        prompts, labels, categories, questions_labels = formatter(dataset, tokenizer)
        with open(f'../features/{args.train_dataset}/{args.model_name}_{args.dataset_name}_categories.pkl', 'wb') as f:
            pickle.dump(categories, f)
    else: 
        prompts, labels, questions_labels = formatter(dataset, tokenizer)
    ...
    print("Saving question labels")
    np.save(f'../features/{args.train_dataset}/{args.model_name}_{args.dataset_name}_question_labels.npy', questions_labels)
